...
const BasmatiRSSFeed = () => {
  ...
  const startScrolling = () => {
    ...
    let startTime = null;
    const duration = 160000; // Increased to 160 seconds for slower scrolling
    ...
    <div className="w-full h-16 bg-gradient-to-r from-black to-gray-900 border-b-2 border-yellow-600 shadow-lg z-30 overflow-hidden fixed top-14">
      ...
      <div className="w-full h-full flex items-center relative bg-black">
        ...
        {/* <button
          ...
          className="absolute right-4 text-yellow-400 hover:text-yellow-200 transition-colors flex items-center gap-2 text-xs bg-yellow-900/30 hover:bg-yellow-800/50 p-2 rounded-lg border border-yellow-600/50"
        >
          <RotateCw
            size={14}
