      ...
      <div className="tw-w-full tw-px-4 sm:tw-px-6 tw-max-w-7xl tw-mx-auto">
        <div className="tw-flex tw-flex-col tw-items-center md:tw-flex-row md:tw-items-center md:tw-justify-between tw-gap-3 sm:tw-gap-4">
          ...
          <div className="tw-flex tw-items-center tw-gap-3 sm:tw-gap-4 tw-flex-wrap tw-justify-center">
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/in/ram-sahare-954730281" // Replace with your LinkedIn
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* Telegram */}
            <a
              href="https://t.me/SAIEXPORTANDIMPORt" // Replace with your Telegram
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* YouTube */}
            <a
              href="https://www.youtube.com/@SaiRiceWorld" // Replace with your YouTube
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* Facebook */}
            <a
              href="https://www.facebook.com/saiimportexport8859" // Replace with your Facebook
              target="_blank"
              rel="noopener noreferrer"
